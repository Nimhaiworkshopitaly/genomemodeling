#!/usr/bin/env python3
"""Joint translocation/inversion grid with core fraction and protection set to zero."""
...
RESULTS = Path("hpc_multicpu/results_joint_translocation_inversion_uniform_no_core")
FIGURES = Path("hpc_multicpu/figures_joint_translocation_inversion_uniform_no_core")
SWARM = Path("hpc_multicpu/jobs_joint_translocation_inversion_uniform_no_core.swarm")
...
def load_results():
    ...
    numeric_checks = {
        "rf": 0.1, "core_fraction": 0.0, "core_protection": 0.0,
...
def analyze() -> None:
    ...
    for metric, label in metrics:
        ...
        ax.set_title(
            ...
            "Lower is better; gain/loss rates fixed at 0.1; no core protection"
        )
