#!/usr/bin/env python3
"""Combine multi-CPU per-job CSV files and rank parameter settings."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Aggregate result CSVs.")
    parser.add_argument("inputs", nargs="+", help="CSV files or glob patterns")
    parser.add_argument("--out-csv", default="hpc_multicpu/combined_results.csv")
    parser.add_argument("--sort-by", default="avg_w1", choices=["avg_w1", "sum_w1"])
...
def main() -> None:
    ...
    cols = ["rf", "rt", "n_runs", "workers", "sum_w1", "avg_w1", "n_pairs", "seed"]
